...
console.log(_id);
    ...
    const handleBorrow = async () => {
        ...
        try {
            const response = await axios.post('https://libraymanagement-nu.vercel.app/borrow', borrowedInfo);
        ...
        if (quantity > 0) {
            try {
                ...
                const response = await axios.patch(`https://libraymanagement-nu.vercel.app/${data.category.toLowerCase()}/${data._id}/borrow`);
