                   ...
                   <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                       {
                           scienceBooks.map(res => 
                            <div 
                            key={res._id} 
                            className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col justify-between"
                          >
                            <div>
                              <img 
                                src={res.image} 
                            ...
                            <button 
                              ...
                              className="mt-4 bg-green-400 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors"
                            >
                              Details
                            </button>
                          </div>
