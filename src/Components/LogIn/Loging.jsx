    ...
    return (
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <span className="text-gray-600 mt-3 font-light underline text-sm">Forget Password</span>
          <div>
             <span className="text-green-500 font-semibold">If you already have an account click to <NavLink className='text-blue-500 underline font-bold' to='/register'>Reg..</NavLink></span>
        </div>
        </form>
